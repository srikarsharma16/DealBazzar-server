...
public class ProductController {
    ...
    @PostMapping("/loadProductImage")
    public ResponseData loadImage(@RequestParam String Imagepath) {
        try {
 ...
 */
    ...
    public ResponseData addImage(@RequestParam String productId, @RequestParam MultipartFile imageFile) {
       ...
       try {
            ...
            // response
            ImageResponseData response = new ImageResponseData();
            response.setImagepath(file.getAbsolutePath());
    ...
    public ResponseData deleteProduct(@RequestBody Product product) {
